...
(type-of-program (scan&parse "proc(int x, bool y) if zero?(1) then 1 else 2"))
(type-to-external-form (type-of-program (scan&parse "proc(int x, bool y) if zero?(1) then 1 else 2")) )
