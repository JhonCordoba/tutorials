...
web_push_1.default.setGCMAPIKey(process.env.FCM_API_KEY);
console.log("PUBLIC_KEY: ", process.env.PUBLIC_VAPID_KEY, "PRIVATE_JEY: ", process.env.PRIVATE_VAPID_KEY, "FCM_API_KEY", process.env.FCM_API_KEY);
